var listFormat = false;var ptBaseURI = getptBaseURI();var const_keyCode = { ARRLEFT : 37,ARRUP : 38,ARRRIGHT : 39,ARRDN : 40,ENTER : 13,
 ...
 tgt.id = "fldra_" + id.replaceAll(/\s/g,'');  tgt = tgt.cloneNode(true);  var p = document.createElement("li");  p.id = id; p.appendChild(tgt); pthNav.iframeDoClick(tgt);  return false;  },
